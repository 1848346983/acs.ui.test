...
public class test {
	...
	public class DataChangeTestcases extends TestCasesBase {
		...
		private  Logger logger = Logger.getLogger(DataChangeTestcases.class);
		private  final String today = DateUtils.getNowString("yyyyMMdd");
		private static final String  FilePath = "./test-output/excelReports/log";
		private  final String saveFilePath ="./test-output/excelReports/" ;
		private  final String zipFilePath ="./test-output/excelReports"  ;
