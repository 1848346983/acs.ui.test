...
public class DataChange_018 extends TestCasesBase {
	
	private static Logger logger = Logger.getLogger(DataChange_018.class);
...
//	private static final String zipFilePath="./test-output/excelReports/" + today +".zip" ;
	...
	public void DC(){
		...
		List<MTestcase> testcases = generateTestcases("核算交易");
