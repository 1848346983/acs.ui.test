package com.testng.plugins.arrow;
...
public class TestResultListener extends TestListenerAdapter {
	...
	//使用com.test.utils包中的MyEventListener监听，该监听器暂时不用
	
	@Override
	public void onTestFailure(ITestResult tr) {
		super.onTestFailure(tr);
		saveScreenShot(tr,TestCasesBase.driver);
...
//		saveScreenShot(tr,TestCaseBase.driver);
